...
star(ax=axes[0], x=-1, y=1, size=0.3, color='yellow', edgecolor='black')
star(ax=axes[0], x=1, y=1, size=0.3, color='orange', edgecolor='darkred')
star(ax=axes[0], x=-1, y=-1, size=0.25, color='lightblue', edgecolor='blue')
star(ax=axes[0], x=1, y=-1, size=0.35, color='red', edgecolor='darkred')
...
star(ax=axes[1], x=-0.8, y=0.5, size=0.4, color='yellow', 
     edgecolor='black', hatch='//')
star(ax=axes[1], x=0.8, y=0.5, size=0.4, color='lightblue', 
     edgecolor='blue', hatch='\\\\')
star(ax=axes[1], x=0, y=-0.7, size=0.4, color='orange', 
     edgecolor='red', hatch='xx')
axes[1].text(0, -1.7, 'Hatch patterns: //, \\\\, xx', ha='center', fontsize=10)

# Test 3: ZAMS star
axes[2].set_title('zams()', fontweight='bold')
zams(ax=axes[2], x=0, y=0.3, size=0.5, 
     label_text='ZAMS\n(Main Sequence)', 
     label_position='bottom')
zams(ax=axes[2], x=0, y=-0.8, size=0.3, 
...
wolf_rayet(ax=axes[3], x=-0.5, y=0.3, size=0.5, 
           label_text='WR Phase\n(He-burning)', 
           label_position='right')
wolf_rayet(ax=axes[3], x=0.5, y=-0.7, size=0.4, 
           label_text='WR Star', 
           label_position='left')
...
supernova_image(ax=axes[4], x=0, y=0.3, size=1.2)
supernova_image(ax=axes[4], x=0, y=-0.8, size=0.6, image_path='nonexistent.png')
...
supernova(ax=axes[5], x=0, y=0, size=1.5, 
